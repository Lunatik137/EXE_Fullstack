...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  }, [url, token, location.pathname]); // Re-fetch when pathname changes
  ...
  return (
    <div className={`sidebar ${isCollapsed ? "collapsed" : ""}`}>
      ...
      {/* Only show Premium section for free users */}
          ...
          >
            ...
            <div className="modal-header">
              ...
              <p className="modal-subtitle">
                Mở khoá toàn bộ tiềm năng sức khoẻ của bạn với chi phí bằng một
                cốc cà phê.
              </p>
            </div>
                ...
                <div className="modal-card-header">
                  ...
                  <div className="modal-price-section">
                    <h3 className="modal-plan-price">
                      39k <span className="modal-price-period">/tháng</span>
                    </h3>
                    <p className="modal-discount-info">
                      Hoặc 379k / năm (Tiết kiệm 20%)
                    </p>
                  </div>
                </div>
